...
data = px.load_workbook(dataDir+"Nutrients.xlsx",data_only=True)
ws = data['Nutrients']
...
data = px.load_workbook(dataDir+"CyanotoxinConcentrations.xlsx",data_only=True)
...
################################################################ ALGAE  ####
data = px.load_workbook(dataDir+"Algae Speciation.xlsx",data_only=True)
...
################################################################ WEATHER ####
data = px.load_workbook(dataDir+"Weather data.xlsx",data_only=True)
...
np.savez(fatherDir+"Data/Preprocessed/Data_hist_interp.npz",LOCS=LOCS,TIME=TIME,NUT1=NUT1,WDEG=WDEG,
